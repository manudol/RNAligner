...
impl Score {
    ...
    pub fn get_algo(&self) -> Result<&str, Box<dyn std::error::Error>> {
        Ok(&self.algo)
    }
    ...
    pub fn get_exp_fold(&self) -> Result<&str, Box<dyn std::error::Error>> {
        Ok(&self.exp_fold)
    }
    
    pub fn get_fold(&self) -> Result<&str, Box<dyn std::error::Error>> {
        Ok(&self.fold)
    }
